    ...
    public class MetricPublisher : IMetricPublisher
    {
        ...
        private Metric GetAppInsightsMetric(MetricIdentifier id, params string[] dimensionNames)
        {
            ...
            switch (dimensionNames.Length)
            {
                ...
                case 3:
                    return _telemetryClient.GetMetric(id.MetricId, dimensionNames[0], dimensionNames[1], dimensionNames[2]);
                case 4:
                    return _telemetryClient.GetMetric(id.MetricId, dimensionNames[0], dimensionNames[1], dimensionNames[2], dimensionNames[3]);
                default:
        ...
        private void TrackValue(Metric metric, double value, params string[] dimensionValues)
        {
            ...
            switch (dimensionValues.Length)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    metric.TrackValue((long)value, dimensionValues[0], dimensionValues[1], dimensionValues[2], dimensionValues[3]);
                    break;
                default:
                    throw new Exception("Too many dimensions");
            }
